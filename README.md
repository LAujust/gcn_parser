...
This is a light-weight package for extracting structured astrophysical information from NASA GCN circulars using an LLM via [OpenRouter](https://openrouter.ai/).
