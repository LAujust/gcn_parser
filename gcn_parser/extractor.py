...
_SYSTEM_PROMPT = (
    ...
    "Dates should be ISO-8601 strings or MJD strings when exact dates are unavailable. "
    ...
    "    value (number or null), band (string or null), instrument (string or null), date (string or null),\n"
